...
!function(t){
	Timeline={
		init:function(e,i){
			...
			s.initials={autoPlayTimer:null,
			direction:"last"!==s.options.startItem?0:1
	},
	s.create_timeline()
},
create_timeline:function(){
	var t=this;t.build_out(),
	t.build_dots(),
	t.watch_events()
},
get_count:function(){
...
content_pause:function(e){
	var i,s=this;i="dots"===e?s.wrapClass+" ."+s.options.dotsClass:s.wrapClass+" ."+s.options.itemClass,t(document.body).on("mouseenter",i,function(t){
		s.autoplay_clear()
	}),
...
change_slide:function(t,e){
	...
	"click"===t?(i.options.startItem=e,
		i.autoplay_init()):i.get_count()-1>i.get_current()&&0===i.initials.direction?i.options.startItem=i
		.get_next():i.get_current()>0&&1===i.initials.direction?i.options.startItem=i
		.get_next():i.autoplay_clear(),
		i.change_timeline()
	},
		move_slide:function(e){
			var i,s,a=this,o=t(a.wrapClass+" .timeline-list-wrap"),
			n=t(a.wrapClass+" ."+a.options.itemClass);"vertical"===e?(i=t(a.wrapClass+" .timeline-list")
			.height(),s=n.outerHeight()*a.get_count(),o.height(s)):(i=t(a.wrapClass+" .timeline-list")
			.width(),s=n.outerWidth()*a.get_count(),o.width(s));
		...
		timelime_calculations:function(){
			var t=this;"vertical"===t.options.mode?t.move_slide("vertical"):t.move_slide("horizontal")},
			move_dots:function(e){
				var i,s,a=this,o=t(a.wrapClass+" .timeline-list"),
				n=t(a.wrapClass+" .timeline-dots li"),
				l=t(a.wrapClass+" .timeline-dots");"vertical"===e?(i=n.outerHeight(!0),s=o.height()):(i=n.outerWidth(!0),s=o.width());
				var r=-(i*a.get_current())- -s/2,p=i*a.get_count();"vertical"===e?(l.height(p),l.css({transform:"translate3d(0px,"+r+"px, 0px)"
	...
	dots_calculations:function(){
		...
		"vertical"===e.options.mode?"right"===e.options.dotsPosition?i.addClass("right"):i
		.addClass("left"):"top"===e.options.dotsPosition?i
		.addClass("top"):i.addClass("bottom")},
		build_out:function(){
			var e=this;e.$elem.addClass("timeline-"+e.options.mode)
			.addClass("timeline-initialized"),
			e.$elem.children()
			.addClass(e.options.itemClass),
			e.$elem.children()
			.wrapAll('<div class="timeline-list-wrap"/>')
			.parent(),e.$elem.children()
			.wrap('<div class="timeline-list"/>')
			.parent(),t("."+e.options.itemClass,e.$elem)
			.eq(e.get_current())
			.addClass(e.options.activeClass),
			e.timelime_calculations(),
			e.update_ui()},
			build_dots:function(){
				var e,s,a=this;for(e=t("<ul />").addClass("timeline-dots"),
				i=0;i<=a.get_count()-1;i+=1)s=t(a.wrapClass+" ."+a.options.itemClass).eq(i).data("time")
				,e.append(t("<li />").append(a.options.customPaging.call(this,a,s)));a.$dots=e.appendTo(a.$elem),
				t(a.wrapClass+" .timeline-dots").wrapAll('<div class="timeline-dots-wrap"/>').parent(),a.dots_calculations(),a.update_ui()},
				update_ui:function(){
					var e=this,
					i=t("."+e.options.itemClass,e.$elem),
					s=t(e.dotsItem);i.removeClass(e.options.activeClass)
					.removeClass(e.options.prevClass).removeClass(e.options.nextClass),
					...
					change_timeline:function(){
						var t=this;t.timelime_calculations(),
						t.dots_calculations(),t.update_ui()}
					},
